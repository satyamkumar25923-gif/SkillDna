              ...
              <div className="lg:col-span-1 space-y-6">
                ...
                <Card className="bg-card border-border/50">
                  ...
                  <CardContent className="space-y-3">
                    <SocialInput label="LinkedIn" icon={LinkedinIcon} value={profile.linkedin} onChange={(v: string) => setProfile({...profile, linkedin: v})} placeholder="satyam-kumar" prefix="linkedin.com/in/" />
                    <SocialInput label="GitHub" icon={GitBranch} value={profile.github} onChange={(v: string) => setProfile({...profile, github: v})} placeholder="satyamk" prefix="github.com/" />
                    <SocialInput label="Twitter/X" icon={TwitterIcon} value={profile.twitter} onChange={(v: string) => setProfile({...profile, twitter: v})} placeholder="satyamk" prefix="x.com/" />
                    <SocialInput label="Website" icon={Globe} value={profile.website} onChange={(v: string) => setProfile({...profile, website: v})} placeholder="https://satyam.dev" prefix="" />
                  </CardContent>
                </Card>
              </div>
            ...
            <Card className="bg-card border-border/50">
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  ...
                  <NotificationToggle label="Weekly Progress Digest" description="Summary of your weekly learning progress" enabled={notifications.weeklyDigest} onChange={(v: boolean) => setNotifications({...notifications, weeklyDigest: v})} />
                  <NotificationToggle label="Skill Assessment Updates" description="When skill assessments are ready or updated" enabled={notifications.skillUpdates} onChange={(v: boolean) => setNotifications({...notifications, skillUpdates: v})} />
                  <NotificationToggle label="Mentor Messages" description="New responses from your AI mentor" enabled={notifications.mentorMessages} onChange={(v: boolean) => setNotifications({...notifications, mentorMessages: v})} />
                  <NotificationToggle label="Job Alerts" description="New job matches for your profile" enabled={notifications.jobAlerts} onChange={(v: boolean) => setNotifications({...notifications, jobAlerts: v})} />
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <NotificationToggle label="Enable Push Notifications" description="Receive browser notifications" enabled={notifications.push} onChange={(v: boolean) => setNotifications({...notifications, push: v})} />
            ...
            <Card className="bg-card border-border/50">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <PrivacyToggle label="Show Progress in Leaderboards" description="Include your progress in community rankings" enabled={privacy.showProgress} onChange={(v: boolean) => setPrivacy({...privacy, showProgress: v})} />
                  <PrivacyToggle label="Show Skills on Profile" description="Display your skill levels publicly" enabled={privacy.showSkills} onChange={(v: boolean) => setPrivacy({...privacy, showSkills: v})} />
                  <PrivacyToggle label="Analytics & Usage Data" description="Help improve the platform with anonymous usage data" enabled={privacy.analytics} onChange={(v: boolean) => setPrivacy({...privacy, analytics: v})} />
                </div>
...
function SocialInput({ label, icon: Icon, value, onChange, placeholder, prefix }: any) {
  return (
